//
//  EqualsClassMethodDescriptionBuilder.swift
//  PolymorphSwiftGen
//
...
class EqualsClassMethodDescriptionBuilder: ClassMethodDescriptionBuilder {

    public static let shared = EqualsClassMethodDescriptionBuilder()
