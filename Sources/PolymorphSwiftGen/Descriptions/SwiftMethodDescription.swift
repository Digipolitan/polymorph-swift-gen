...
struct SwiftMethodDescription {
    ...
    struct Options {
        ...
        public init(visibility: SwiftVisibility = .public, isStatic: Bool = false, isOverride: Bool = false, isMutating: Bool = false) {
