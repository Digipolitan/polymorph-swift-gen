//
//  SwiftInitializerDescription.swift
//  PolymorphSwiftGen
//
...
struct SwiftInitializerDescription {
    ...
    struct Options {
        ...
        public init(visibility: SwiftVisibility = .public, isOverride: Bool = false, isConvenience: Bool = false, isOptional: Bool = false, isRequired: Bool = false) {
